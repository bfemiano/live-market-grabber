...
public class LiveMarketGrabber {
	...
	public static HashMap<String, Object> getLatestPrices() throws MarketUnparsableException{
		...
		try {
			...
			latestPrices.put("ga", Double.parseDouble(goldNewYorkAsk));
			latestPrices.put("gb", Double.parseDouble(goldNewYorkBid));
			latestPrices.put("sa", Double.parseDouble(silverNewYorkAsk));
			latestPrices.put("sb", Double.parseDouble(silverNewYorkBid));
			latestPrices.put("gwb", Double.parseDouble(goldWorldBid));
			latestPrices.put("gwa", Double.parseDouble(goldWorldAsk));
			latestPrices.put("swb", Double.parseDouble(silverWorldBid));
			latestPrices.put("swa", Double.parseDouble(silverWorldAsk));
			latestPrices.put("plb", Double.parseDouble(platinumBid));
			latestPrices.put("pla", Double.parseDouble(platinumAsk));
			latestPrices.put("pab", Double.parseDouble(palladiumBid));
			latestPrices.put("paa", Double.parseDouble(palladiumAsk));
